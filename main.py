...
TOKEN_API = '7347629243:AAG6_4UEDxxShm4NZ1UTE54Mqym8Xu3cPaw'
...
async def go_to_1(callback_query: types.CallbackQuery):
    await callback_query.message.edit_text('Ты перешел на 2 клавиатуру, нажми кнопку, чтобы вернуться на 1', reply_markup=keyboard2)


@dp.callback_query_handler(lambda c: c.data == 'go_to_1')
async def go_to_2(callback_query: types.CallbackQuery):
    await callback_query.message.edit_text('Ты перешел на 1 клавиатуру, нажми кнопку, чтобы вернуться на 2', reply_markup=keyboard1)
